...
import { generatePlanSchema, validationErrorResponse } from '@/lib/validation';
...
async function retrieveContext(
  ...
  try {
    ...
    return { context: '', usedRag: false, ragReason: 'embeddings_error' };
  }
}
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { departureCity, destination, startDate, endDate, budget } = validationResult.data;
